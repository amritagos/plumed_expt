...
def main(
    ...
    # Create the LAMMPS calculator object (perhaps could be replaced by IdealGas calculator?)
    # -----------------------------------------------------
    # Parameters
    ...
    calc_plumed.write_plumed_files(traj)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Using PLUMED to analyze a concatenated biased trajectory."
    )
    parser.add_argument(
        "--in_traj",
        type=Path,
        required=True,
        help="Path to concatenated biased trajectory",
    )
    parser.add_argument(
        "--max_cutoff",
        type=float,
