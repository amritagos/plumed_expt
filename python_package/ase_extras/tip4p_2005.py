...
qH = 0.5564
sigma0 = 3.1589 # In Angstroms 
epsilon0 = 0.1852 * units.kcal / units.mol # Originally in kcal/mol, converted to ASE units 
# https://doi.org/10.1063/1.2121687 


class TIP4P_2005(TIP3P):
    def __init__(self, rc=7.0, width=1.0):
        """ TIP4P/2005 potential for water.
    ...
    def add_virtual_sites(self, pos):
        # Order: OHHM,OHHM,...
        # DOI: https://doi.org/10.1063/1.2121687
        b = 0.1546 # OM distance 
